...
namespace PicklesDoc.Pickles.Test
{
    ...
    public class WhenWorkingWithHtmlResources : BaseFixture
    {
        ...
        public void ThenSavesCssFilesToCorrectLocation()
        {
            ...
            Check.That(filesOnFileSystem).Contains(@"/output/css/master.css");
            Check.That(filesOnFileSystem).Contains(@"/output/css/reset.css");
            Check.That(filesOnFileSystem).Contains(@"/output/css/global.css");
            Check.That(filesOnFileSystem).Contains(@"/output/css/global.css");
            Check.That(filesOnFileSystem).Contains(@"/output/css/structure.css");
            Check.That(filesOnFileSystem).Contains(@"/output/css/print.css");
            Check.That(filesOnFileSystem).Contains(@"/output/css/font-awesome.css");
        }
    }
}
