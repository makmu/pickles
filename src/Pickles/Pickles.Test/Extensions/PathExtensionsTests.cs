...
namespace PicklesDoc.Pickles.Test.Extensions
{
    ...
    internal class PathExtensionsTests : BaseFixture
    {
        ...
        public void Get_A_Relative_Path_When_Location_Is_Deeper_Than_Root()
        {
            ...
            fileSystem.AddFile(@"/test/deep/blah.feature", "Feature:"); // adding a file automatically adds all parent directories

            string actual = PathExtensions.MakeRelativePath(@"/test", @"/test/deep/blah.feature", fileSystem);
